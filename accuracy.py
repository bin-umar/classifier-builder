...
def main():
    ...
    parser.add_argument("--method", default="top1-with-threshold",
                        choices=["top1", "top5", "top1-with-threshold"])
    parser.add_argument("--threshold", type=float, default=0.2,
                        help="Only applies when --method=top1-with-threshold")
    ...
    with open(args.csv_file) as f:
        ...
        for row in reader:
            ...
            if label == "cart":
                if match("cart", predictions, args.method, args.threshold):
                    true_positives +=1
                else:
                    false_negatives +=1
